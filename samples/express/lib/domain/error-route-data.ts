...
const errorRoutes = Object.freeze([
  {
    ...
    context: Object.freeze({ user: complexUserContext.user }),
  },
  {
  ...
  },
  {
    ...
    context: Object.freeze({ user: Object.freeze({ name: 'Alice', status: 'active' }) }),
  },
  {
  ...
  },
  {
    ...
    context: Object.freeze({ product: null }),
  },
  ...
  },
  {
    ...
    context: Object.freeze({ items: Object.freeze([Object.freeze({ name: 'test' })]) }),
  },
  {
    path: 'groupby-filter',
    template: 'errors/groupby-filter.njk',
    context: Object.freeze({ items: 42 }),
  },
  {
