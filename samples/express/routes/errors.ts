...
router.get('/filter-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/filter-error.njk', {
...
router.get('/undefined-block', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/undefined-block.njk', {
      context: {},
...
router.get('/no-super-block', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{% block content %}{{ super() }}{% endblock %}', {
      context: {},
      config: { dev: true },
    })
  );
...
router.get('/reserved-keyword', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ super() }}', { context: {}, config: { dev: true } })
  );
});
...
router.get('/no-super-block-template', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/no-super-block.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/invalid-include', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/invalid-include.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/circular-include', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/circular-include.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/file-not-found', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/file-not-found.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/filesystem-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/filesystem-error.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/inline-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ undefinedVar }}', {
      context: {},
...
router.get('/sandbox-proto', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ user.__proto__ }}', {
      context: { user: {} },
...
router.get('/sandbox-constructor', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ user.constructor }}', {
      context: { user: {} },
      config: { dev: true, security: { sandbox: true } },
    })
  );
...
router.get('/sandbox-process', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ user.global }}', {
...
router.get('/slice-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ [1,2,3][::0] }}', { context: {}, config: { dev: true } })
  );
});
...
router.get('/in-operator-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ key in value }}', {
...
router.get('/filter-throw', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ "test" |> throwingFilter }}', {
      context: {},
      config: {
        dev: true,
        filters: {
...
router.get('/sandbox-context-modify', async (_req: Request, res: Response, next: NextFunction) => {
  ...
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ modifyContext() }}', {
      context: {
        modifyContext: () => {
...
router.get('/blocked-custom-key', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ creditCard }}', {
...
router.get('/no-blocked-context-keys', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ password.upper() }}', {
...
router.get(
  ...
  async (_req: Request, res: Response, next: NextFunction) => {
    sendTemplateResult(
      res,
      next,
      await renderTemplate('{{ user.name }}', {
...
router.get('/template-size', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('x'.repeat(10000), {
      context: {},
...
router.get('/key-not-found', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ missingKey }}', {
      context: {},
      config: { dev: true, undefined: 'strict' },
    })
  );
...
router.get('/import-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/import-error.njk', {
      context: {},
      config: { dev: true, undefined: 'strict', views: VIEWS },
    })
  );
...
router.get('/container-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ container.get("missing") }}', {
...
router.get('/groupby-type-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ items |> groupby("missing") }}', {
...
router.get('/parser-unexpected-token', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{% if true %}{% endif %}{{ ', { context: {}, config: { dev: true } })
  );
});
...
router.get('/sandbox-allowlist', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ customVar }}', {
...
router.get('/sandbox-code-execution', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ setTimeout("alert(1)", 0) }}', {
      context: { setTimeout },
      config: { dev: true, security: { sandbox: true } },
    })
  );
...
router.get('/sandbox-context-error', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ user.something }}', {
...
router.get('/container-factory', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ container.get("test") }}', {
...
router.get(
  ...
  async (_req: Request, res: Response, next: NextFunction) => {
    sendTemplateResult(
      res,
      next,
      await renderTemplate('{{ myContainer.get("test") }}', { context: {}, config: { dev: true } })
    );
  }
);
...
router.get('/template-must-be-string', async (_req: Request, res: Response, next: NextFunction) => {
  ...
  sendTemplateResult(
    res,
    next,
    await renderTemplate(invalidResult.value, { context: {}, config: { dev: true } })
  );
});
...
router.get('/undefined-value-match', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('{{ product.name }}', {
...
router.get('/', async (_req: Request, res: Response, next: NextFunction) => {
  sendTemplateResult(
    res,
    next,
    await renderTemplate('errors/index.njk', {
      context: {
        groups: errorGroups,
