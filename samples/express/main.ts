...
import { renderToStream, toWebReadableStream } from '@nunjucks/core';
...
// WHY: manual for-await — maximum control (e.g. timing, per-chunk logging, inlining errors).
...
// WHY: adapter path — toWebReadableStream turns the AsyncGenerator into a Web ReadableStream, then Node's Readable.fromWeb bridges it to the HTTP response. Same streaming behaviour, less boilerplate.
