...
// engine contract (a template-state machine whose load/compile/render phases throw into
// the Tier-3 fatal path per ARCHITECTURE.md §8) and is consumed only by the render
// pipeline, which catches and converts every throw back into `err(...)` at the boundary.
