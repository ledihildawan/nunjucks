...
const TEST_TESTS: readonly TestDefinition[] = [
  ...
  { name: 'float', category: 'primitive', args: 0, description: 'Value is a float (non-integer number)' },
  ...
  { name: 'object', category: 'collection', args: 0, description: 'Value is an object (not null, typeof object)' },
  ...
  { name: 'asynciterable', category: 'collection', args: 0, description: 'Value has a Symbol.asyncIterator' },
  ...
  { name: 'asyncfunction', category: 'objectType', args: 0, description: 'Value is an async function' },
  ...
  { name: 'between', category: 'numeric', args: 2, description: 'Value is between min and max (inclusive)' },

  { name: 'empty', category: 'string', args: 0, description: 'Value is empty string' },
  { name: 'blank', category: 'string', args: 0, description: 'Value is blank (empty or whitespace only)' },
  ...
  { name: 'alpha', category: 'string', args: 0, description: 'Value contains only alphabetic characters' },
  { name: 'alphanumeric', category: 'string', args: 0, description: 'Value contains only alphanumeric characters' },
  { name: 'numeric', category: 'string', args: 0, description: 'Value contains only numeric characters' },
  { name: 'startswith', category: 'string', args: 1, description: 'Value starts with the given string' },
  { name: 'endswith', category: 'string', args: 1, description: 'Value ends with the given string' },
  { name: 'contains', category: 'string', args: 1, description: 'Value contains the given string/element' },
  { name: 'matches', category: 'string', args: 1, description: 'Value matches the given regex pattern' },

  { name: 'sameas', category: 'equality', args: 1, description: 'Value is strictly same as (===)' },
  { name: 'equalto', category: 'equality', args: 1, description: 'Value is equal to (deep equality)' },

  { name: 'has', category: 'property', args: 1, description: 'Object has the key (using in operator)' },
  { name: 'hasown', category: 'property', args: 1, description: 'Object has own property (Object.hasOwn)' },
...
const TEST_KEYWORDS: ReadonlySet<string> = new Set(
  TEST_TESTS.map((t) => t.name)
);
