...
export const TEMPLATE_ERRORS = {
  VALIDATION_ERROR: {
    ...
    fixCode: 'nunjucks({ limits: { {subject}: 1000 } })',
  ...
  TEMPLATE_SIZE_EXCEEDED: {
    ...
    message: 'Template exceeds maximum size of {max} characters',
    ...
    fixCode: 'nunjucks({ limits: { maxTemplateSize: 1024 * 1024 } })  // 1 MB',
    fixComment: 'Increase `maxTemplateSize` or split the template into smaller files',
    subjectFrom: null,
  },
  OUTPUT_SIZE_EXCEEDED: {
    name: 'OUTPUT_SIZE_EXCEEDED',
    message: 'Rendered output exceeds maximum size of {max} characters',
